...
object x {
  ...
  val words =
    in.getLines.toList filter (word => word forall (chr => chr.isLetter))
  ...
  /**
    map digit string to List of words
    eg : "5282" -> List("Java", ....)
  */
  ...
  /** given string number return List of words */
